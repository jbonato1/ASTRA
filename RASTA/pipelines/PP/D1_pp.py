...
folder_single = '/media/DATA/jbonato/astro_segm/set1/train_single/'
    ...
    if os.path.isdir(dataset_dir) and flag_go and int(item)<26:
        ...
        for image_id in image_ids:
            ...
            if not(os.path.isdir(path_to_file)):
                ...
                stack,im_enh = sp_pp.create_img() #see gen_single_astro.py for different spatial pp
                ...
                values,values_soma =  save_im(im=im_enh,stack=stack,mask_soma=values_soma,mask_proc=values,\
                                              ...
                                              BB_dim=86,th1_p=th1_p,th2_p=th2_p)